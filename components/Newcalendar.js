                    ...
                    <div className="col-sm-3" style={{marginTop:"20px"}}>
                      <div id="card" className="card" >
                        <div className="card-body" style={{color:"black"}}>
                          <h1 className="card-title" onClick={e => this.main(upcome, i)}><b>{upcome.date.datetime.day}</b></h1>
                  ...
                  : this.state.log === "passed" ? <div className="row" >
                    {
                      ...
                      <div className="col-sm-3" style={{marginTop:"20px"}}>
                        <div id="card" className="card">
                          <div className="card-body" style={{color:"black"}}>
                            <h1 className="card-title" onClick={e => this.main(pass, i)}>{pass.date.datetime.day}</h1>
